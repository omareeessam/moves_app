import 'dart:convert';
MoviesResponse moviesFromJson(String str) => MoviesResponse.fromJson(json.decode(str));
String moviesToJson(MoviesResponse data) => json.encode(data.toJson());
